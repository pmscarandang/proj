...
//			Card var1 = tableau[0].get(i);
//			if (var1.rank == 13) {
//				tableau[emptyTableau].addAll(tableau[0].subList(i, tableau[0].size() - 1));
//
//			}
//		}
//
//		for (int i = 0; i < tableau[1].size() - 1; i++) {
//			Card var1 = tableau[1].get(i);
//			if (var1.rank == 13) {
//				tableau[emptyTableau].addAll(tableau[1].subList(i, tableau[1].size() - 1));
//
//			}
//		}
//
//		for (int i = 0; i < tableau[2].size() - 1; i++) {
//			Card var1 = tableau[2].get(i);
//			if (var1.rank == 13) {
//				tableau[emptyTableau].addAll(tableau[2].subList(i, tableau[2].size() - 1));
//
//			}
//		}
//
//		for (int i = 0; i < tableau[3].size() - 1; i++) {
//			Card var1 = tableau[3].get(i);
//			if (var1.rank == 13) {
//				tableau[emptyTableau].addAll(tableau[3].subList(i, tableau[3].size() - 1));
//
//			}
//		}
//
//		for (int i = 0; i < tableau[4].size() - 1; i++) {
//			Card var1 = tableau[4].get(i);
//			if (var1.rank == 13) {
//				tableau[emptyTableau].addAll(tableau[4].subList(i, tableau[4].size() - 1));
//
//			}
//		}
//
//		for (int i = 0; i < tableau[5].size() - 1; i++) {
//			Card var1 = tableau[5].get(i);
//			if (var1.rank == 13) {
//				tableau[emptyTableau].addAll(tableau[5].subList(i, tableau[5].size() - 1));
//
//			}
//		}
//
//		for (int i = 0; i < tableau[6].size() - 1; i++) {
//			Card var1 = tableau[6].get(i);
//			if (var1.rank == 13) {
//				tableau[emptyTableau].addAll(tableau[6].subList(i, tableau[6].size() - 1));
//
//			}
//		}
	...
	public boolean moveWithinTableau(Card currentCard, int currentIndex) {
		...
		for (int j = 0; j < numTableau; j++) {
			if (currentIndex != j && tableau[j].isEmpty() && currentCard.rank == 13) {
				...
				return true; // break after moving the King to an empty tableau
			}
